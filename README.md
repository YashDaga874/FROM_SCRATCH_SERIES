...
\[02] HMM - Hidden Markov Models \- 
                                  Implemented it from scratch and used a synthetic dataset to train the model and predict the forecast for the next 10 days (from the 100th day onwards.).\
